...
export default function MercedesGLSpage() {
  const car = cars[4]; // Get the first car directly
  useEffect(() => {
  ...
  return (
    <>
      ...
      <Image
        ...
        className=""
        src="/assets/imgs/fleet/Mercedes GLS.jpg"
        alt="luxride"
      />
          ...
          <div className="content-single wow fadeInUp">
            ...
            <ul className="list-ticks list-ticks-small">
              <li className="text-16 mb-20">
                <strong>✔ Premium Full-Size SUV Fleet</strong><br />
                Our Mercedes GLS models offer exceptional space, luxury, and a commanding on-road presence.
              </li>
              <li className="text-16 mb-20">
                <strong>✔ Professionally Prepared Vehicles</strong><br />
                Each GLS is fully cleaned, inspected, and detailed before your pickup.
              </li>
              <li className="text-16 mb-20">
                <strong>✔ Safe & Comfortable Journeys</strong><br />
                Driven by professional chauffeurs who know Melbourne's roads and deliver a safe, smooth ride.
              </li>
              <li className="text-16 mb-20">
                <strong>✔ Extra Room & First-Class Comfort</strong><br />
                Perfect for families, business groups, or clients who prefer wide seating and large cargo space.
              </li>
              <li className="text-16 mb-20">
                <strong>✔ Polite & Experienced Chauffeurs</strong><br />
                Friendly, punctual, and committed to giving you a top-level travel experience.
              </li>
            </ul>
            <div className="mt-30">
      ...
      <div className="box-slide-fleet mt-120 wow fadeInUp">
        ...
        <div className="container-sub">
          <h2 className="heading-44-medium wow fadeInUp">
            Features of Our Mercedes GLS Vehicles
          </h2>
          <div className="row mt-50 cardIconTitleDescLeft">
              ...
              <div className="cardIconTitleDesc wow fadeInUp">
                ...
                <div className="cardDesc">
                  <p className="text-16 color-text">
                    Equipped with the latest Mercedes safety systems for a secure and confidence-boosting journey.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-6 mb-30">
              <div className="cardIconTitleDesc wow fadeInUp">
                ...
                <div className="cardDesc">
                  <p className="text-16 color-text">
                    Transparent rates with no hidden charges — premium service with honest pricing.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-6 mb-30">
              <div className="cardIconTitleDesc wow fadeInUp">
                ...
                <div className="cardDesc">
                  <p className="text-16 color-text">
                    A calm interior perfect for relaxing, working, or enjoying the ride with extra legroom.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-6 mb-30">
              <div className="cardIconTitleDesc wow fadeInUp">
                ...
                <div className="cardTitle">
                  <h5 className="text-20-medium color-text">Smooth All-Road Performance</h5>
                </div>
                <div className="cardDesc">
                  <p className="text-16 color-text">
                    Strong handling and smooth suspension make the GLS ideal for any route and weather.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-6 mb-30">
              <div className="cardIconTitleDesc wow fadeInUp">
                ...
                <div className="cardDesc">
                  <p className="text-16 color-text">
                    Handled by trained drivers who prioritize comfort, safety, and punctuality.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-6 mb-30">
              <div className="cardIconTitleDesc wow fadeInUp">
                ...
                <div className="cardDesc">
                  <p className="text-16 color-text">
                    The GLS delivers a strong yet elegant drive, combining performance with refinement.
                  </p>
                </div>
              </div>
            </div>
