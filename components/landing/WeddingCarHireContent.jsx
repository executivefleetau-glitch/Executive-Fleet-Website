    ...
    <>
      <section className="lp-hero" id="top">
        <div className="hero-bg">
          <Image src="/assets/hero/executive-fleet-hero-bg.webp" alt="Wedding Car Hire Melbourne" fill priority quality={80} style={{ objectFit: 'cover', objectPosition: 'center' }} />
          ...
          <div className="hero-grid">
            <div className="hero-content">
              <div className="trust-badge">
                ...
                <span className="badge-text">Melbourne's Premier Wedding Transport</span>
              </div>
              <h1 className="hero-title">Wedding Car Hire<span className="title-highlight">Melbourne</span></h1>
              <p className="hero-subtitle">Make your special day truly unforgettable with our luxury wedding car service. Elegant vehicles, professional chauffeurs, and impeccable service.</p>
              <div className="hero-features">
                <div className="feature-item"><div className="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg></div><span>Luxury Vehicles</span></div>
                <div className="feature-item"><div className="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></div><span>Romance Touches</span></div>
                ...
                <div className="feature-item"><div className="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg></div><span>Flexible Timing</span></div>
              </div>
      ...
      <section className="lp-stats">
        <div className="landing-container">
          <div className="stats-grid">
            <div className="stat-item"><span className="stat-number">300+</span><span className="stat-label">Weddings Served</span></div>
            <div className="stat-divider"></div>
            <div className="stat-item"><span className="stat-number">5.0</span><span className="stat-label">Google Rating</span></div>
            <div className="stat-divider"></div>
            <div className="stat-item"><span className="stat-number">100%</span><span className="stat-label">Happy Couples</span></div>
            <div className="stat-divider"></div>
            <div className="stat-item"><span className="stat-number">6+</span><span className="stat-label">Premium Vehicles</span></div>
          </div>
        </div>
      </section>
      ...
      <section className="lp-why">
        <div className="landing-container">
          <div className="section-header"><span className="section-tag">Why Executive Fleet</span><h2>Your Perfect Wedding Day Transport</h2></div>
          <div className="why-grid">
            <div className="why-card"><div className="card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg></div><h3>Stunning Vehicles</h3><p>Mercedes S-Class, BMW 7-Series, and luxury SUVs - all immaculately presented for your big day.</p></div>
            <div className="why-card"><div className="card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></div><h3>Romantic Details</h3><p>Champagne service, ribbon decorations, and red carpet treatment available on request.</p></div>
            <div className="why-card"><div className="card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg></div><h3>Professional Service</h3><p>Impeccably dressed chauffeurs who understand the importance of your special day.</p></div>
            <div className="why-card"><div className="card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/></svg></div><h3>Flexible Packages</h3><p>From ceremony only to full-day hire. We'll work around your schedule perfectly.</p></div>
            <div className="why-card"><div className="card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg></div><h3>Photo Opportunities</h3><p>We allow time for photos with the vehicle. Your memories deserve the perfect backdrop.</p></div>
            <div className="why-card"><div className="card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div><h3>Bridal Party Transport</h3><p>Multiple vehicles available for bridesmaids, groomsmen, and family members.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="lp-cta">
        <div className="landing-container">
          <div className="cta-content">
            ...
            <p>Get a free quote for your wedding transport today.</p>
