    ...
    <>
      <section className="lp-hero" id="top">
        <div className="hero-bg">
          <Image src="/assets/hero/executive-fleet-hero-bg.webp" alt="Special Events Chauffeur Melbourne" fill priority quality={80} style={{ objectFit: 'cover', objectPosition: 'center' }} />
        ...
        <div className="landing-container">
          <div className="hero-grid">
            <div className="hero-content">
              ...
              <h1 className="hero-title">Special Events<span className="title-highlight">Chauffeur Service</span></h1>
              <p className="hero-subtitle">From gala dinners to Spring Racing Carnival, we make every event memorable with luxury transport that matches the occasion.</p>
              <div className="hero-features">
                <div className="feature-item"><div className="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg></div><span>VIP Treatment</span></div>
                <div className="feature-item"><div className="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg></div><span>All Melbourne Events</span></div>
                <div className="feature-item"><div className="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg></div><span>Suited Chauffeurs</span></div>
                <div className="feature-item"><div className="feature-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div><span>On-Time Promise</span></div>
              </div>
      ...
      <section className="lp-stats">
        <div className="landing-container">
          <div className="stats-grid">
            <div className="stat-item"><span className="stat-number">800+</span><span className="stat-label">Events Served</span></div>
            <div className="stat-divider"></div>
            <div className="stat-item"><span className="stat-number">5.0</span><span className="stat-label">Google Rating</span></div>
            <div className="stat-divider"></div>
            <div className="stat-item"><span className="stat-number">100%</span><span className="stat-label">Punctuality</span></div>
            <div className="stat-divider"></div>
      ...
      <section className="lp-why">
        <div className="landing-container">
          <div className="section-header"><span className="section-tag">Why Executive Fleet</span><h2>Your Premium Event Transport Partner</h2></div>
          <div className="why-grid">
            <div className="why-card"><div className="card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M8 21h8M12 21V11M17 6l-5 5-5-5M17 3l-5 5-5-5"/></svg></div><h3>Spring Racing Carnival</h3><p>Melbourne Cup, Flemington, Caulfield - arrive in style to the races without parking worries.</p></div>
            <div className="why-card"><div className="card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg></div><h3>Gala Events</h3><p>Awards nights, charity galas, and formal events. Make an entrance that matches the occasion.</p></div>
            <div className="why-card"><div className="card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg></div><h3>Birthdays & Anniversaries</h3><p>Celebrate milestones in style. Surprise your loved ones with luxury transport.</p></div>
            <div className="why-card"><div className="card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg></div><h3>Concerts & Theatre</h3><p>Rod Laver Arena, Marvel Stadium, Arts Centre. Skip traffic and arrive relaxed.</p></div>
            <div className="why-card"><div className="card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg></div><h3>Photo Shoots</h3><p>Our vehicles provide the perfect backdrop for fashion shoots, engagement photos, and more.</p></div>
            <div className="why-card"><div className="card-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div><h3>Group Events</h3><p>From school formals to bucks nights. Multiple vehicles available for larger groups.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="lp-cta">
        <div className="landing-container">
          <div className="cta-content">
            ...
            <p>Book your luxury event transport today.</p>
