          ...
          <div className="container-sub">
            <div className="row mb-40">
              <div className="col-lg-8 wow fadeInUp">
                <h2 className="heading-44-medium color-white mb-20">
                  Contact Us
                </h2>
                <p className="text-16 color-white mb-60">
                ...
                <div className="row">
                  <div className="col-lg-4 col-md-4 mb-30">
                    <span className="text-14 color-white-2">Address</span>
                    <p className="text-18-medium color-white mt-5 address-footer">
                      184 Main Collins Street West Victoria 8007
                    </p>
                  </div>
                  <div className="col-lg-4 col-md-4 mb-30">
                    <span className="text-14 color-white-2">Working Hours</span>
                    <p className="text-18-medium color-white mt-5 time-footer">
                      Mon-Sat: 09:00 - 17:00
                      <br />
                      Sun: Closed
                    </p>
                  ...
                  <div className="col-lg-4 col-md-4 mb-30">
                    <span className="text-14 color-white-2">
                      Call Our Office
                    </span>
                    <p className="text-18-medium color-white mt-5 call-footer">
                      +41 22 715 7000
                    </p>
                  </div>
                </div>
