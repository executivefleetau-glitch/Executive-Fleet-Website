      ...
      <div className="container-sub">
        <div className="reviews-header-section mb-60 wow fadeInUp">
          ...
          <div className="rating-badge">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="#ce9b28">
              <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
            </svg>
            <div className="rating-content">
              ...
              <div className="rating-stars">
                {[...Array(5)].map((_, index) => (
                  <svg key={index} width="14" height="14" viewBox="0 0 24 24" fill="#ce9b28">
                    <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                  </svg>
                ))}
              </div>
              <div className="rating-label">Verified Reviews</div>
            </div>
          </div>
        </div>
